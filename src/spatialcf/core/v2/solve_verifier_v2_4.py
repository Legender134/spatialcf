"""Independent replay verification for exact cardinal-camera 2.4 results."""
...
from spatialcf.core.v2.minimum_cost_solver_v2_4 import (
...
def verify_canonical_solve_result_v2_4(
    ...
    """Replay with trusted 2.4 inputs and compare complete canonical bytes."""
    ...
    return verify_solve_replay_v2(
        ...
        bindings=SolveReplayBindingsV2(
            ...
            solve=solve_canonical_minimum_cost_v2_4,
...
class CanonicalSolveResultVerifierV2_4:
    """Stateless wrapper for independent exact cardinal-camera replay."""
    ...
    def verify(
        ...
        return verify_canonical_solve_result_v2_4(
            problem,
            expected_config,
            submitted_result,
        )
...
__all__ = (
    "CanonicalSolveResultVerifierV2_4",
    "verify_canonical_solve_result_v2_4",
)
