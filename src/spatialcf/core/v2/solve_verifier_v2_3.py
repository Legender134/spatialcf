"""Independent replay verification for exact camera-translation 2.3 results."""
...
from spatialcf.core.v2.minimum_cost_solver_v2_3 import (
...
def verify_canonical_solve_result_v2_3(
    ...
    """Replay with trusted 2.3 inputs and compare complete canonical bytes."""
    ...
    return verify_solve_replay_v2(
        ...
        bindings=SolveReplayBindingsV2(
            ...
            solve=solve_canonical_minimum_cost_v2_3,
...
class CanonicalSolveResultVerifierV2_3:
    """Stateless wrapper for independent camera-translation replay."""
    ...
    def verify(
        ...
        return verify_canonical_solve_result_v2_3(
            problem,
            expected_config,
            submitted_result,
        )
...
__all__ = (
    "CanonicalSolveResultVerifierV2_3",
    "verify_canonical_solve_result_v2_3",
)
