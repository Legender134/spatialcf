"""Independent replay verification for zero-distortion 2.2 results."""
...
from spatialcf.core.v2.minimum_cost_solver_v2_2 import (
...
def verify_canonical_solve_result_v2_2(
    ...
    """Replay with trusted 2.2 inputs and compare complete canonical bytes."""
    ...
    return verify_solve_replay_v2(
        ...
        bindings=SolveReplayBindingsV2(
            ...
            solve=solve_canonical_minimum_cost_v2_2,
...
class CanonicalSolveResultVerifierV2_2:
    """Stateless object wrapper for independent zero-distortion replay."""
    ...
    def verify(
        ...
        return verify_canonical_solve_result_v2_2(
            problem,
            expected_config,
            submitted_result,
        )
...
__all__ = (
    "CanonicalSolveResultVerifierV2_2",
    "verify_canonical_solve_result_v2_2",
)
