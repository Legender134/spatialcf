...
from spatialcf.core._internal.objective.base import (
...
from spatialcf.domain.artifacts import NonNegativeIntervalV2, ObjectiveTermBoundsV2
...
class _ContinuousYawObjectiveProposalV2_9:
    ...
    def __post_init__(self) -> None:
        ...
        if type(self.edit) is not CanonicalEdit:
            raise TypeError("edit must be an exact CanonicalEdit")
        object.__setattr__(
            self,
            "edit",
            CanonicalEdit.model_validate(
...
def evaluate_continuous_yaw_objective_point_v2_9(
    ...
    *,
    ...
    if type(edit) is not CanonicalEdit:
        raise TypeError("edit must be an exact CanonicalEdit")
    edit = CanonicalEdit.model_validate(
