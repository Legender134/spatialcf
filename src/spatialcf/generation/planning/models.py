...
class SubjectPlacementFact(CanonicalModel):
...
class ProxyBinding(CanonicalModel):
    ...
    def proxy_binding_sha256(self) -> Sha256Digest:
        return canonical_sha256(self, domain=_BINDING_HASH_DOMAIN)


class ProxyBundle(CanonicalModel):
