"""Final capture-to-fresh-source correspondence authority."""
...
def request_binding_sha256(request: BatchRequest) -> Sha256Digest:
    ...
    return canonical_sha256(checked, domain=_REQUEST_BINDING_HASH_DOMAIN)


class RequestLineage(CanonicalModel):
    ...
    def request_lineage_sha256(self) -> Sha256Digest:
        return canonical_sha256(self, domain=_REQUEST_LINEAGE_HASH_DOMAIN)
...
class CaptureSourceCorrespondence(CanonicalModel):
