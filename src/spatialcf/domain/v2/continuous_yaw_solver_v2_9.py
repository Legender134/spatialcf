...
consumer must pass a submitted result to the pure-core v2.9 verifier before
...
from spatialcf.domain.v2.continuous_yaw_camera import SchemaIdentityV2_3
...
class ContinuousYawResourceUsageV2_9(V2Model):
...
class ContinuousYawSolverConfigV2_9(V2Model):
    ...
    def config_sha256(self) -> Sha256Digest:
        return canonical_sha256_v2(self, domain=_CONFIG_HASH_DOMAIN_V2_9)


class ContinuousYawCandidateRefsV2_9(V2Model):
    ...
    def candidate_refs_sha256(self) -> Sha256Digest:
        return canonical_sha256_v2(self, domain=_CANDIDATE_REFS_HASH_DOMAIN_V2_9)


class ContinuousYawObjectiveCellV2_9(V2Model):
...
class ContinuousYawWitnessEvaluationV2_9(V2Model):
    ...
    def witness_evaluation_sha256(self) -> Sha256Digest:
        return canonical_sha256_v2(self, domain=_WITNESS_HASH_DOMAIN_V2_9)


class ContinuousYawGlobalOptimalityCertificateV2_9(V2Model):
    ...
    def certificate_sha256(self) -> Sha256Digest:
        return canonical_sha256_v2(self, domain=_CERTIFICATE_HASH_DOMAIN_V2_9)
...
class _ContinuousYawSolveResultBaseV2_9(V2Model):
    semantic_problem_sha256: Sha256Digest
    candidate_problem_sha256: Sha256Digest
    ...
    def solve_result_sha256(self) -> Sha256Digest:
        return canonical_sha256_v2(self, domain=_SOLVE_RESULT_HASH_DOMAIN_V2_9)
...
class ContinuousYawMinimumCostSolveOutcomeV2_9(V2Model):
...
class ContinuousYawSolveVerificationOutcomeV2_9(V2Model):
