"""Current deterministic core configuration and solve-result contracts.
...
from spatialcf.domain.certificate import (
...
class _GeometryKernelSpecBaseV2(CanonicalModel):
...
class CoreSolverConfigV2(CanonicalModel):
...
class _CanonicalSolveResultBaseV2(CanonicalModel):
    ...
    def solve_result_sha256(self) -> Sha256Digest:
        return canonical_sha256(self, domain=_SOLVE_RESULT_HASH_DOMAIN)
