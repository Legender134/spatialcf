"""Platform-neutral current semantic certificate contracts.
...
class GlobalOptimalityCertificateV2(CanonicalModel):
...
class ProvenUnsatCertificateV2(CanonicalModel):
